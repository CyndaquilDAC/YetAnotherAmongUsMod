...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("arial.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt = new FlxText(15, 15, FlxG.width, "", 20);
		scoreTxt.setFormat(Paths.font("arial.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	override public function update(elapsed:Float)
	{
		...
		scoreTxt.text = 'Song: ' + SONG.song.replace('-', ' ')
		+ ',\nScore: ' + songScore
		+ ',\nMisses: ' + songMisses
		+ ',\nRating: ' + ratingName
		...
		if(ret != FunkinLua.Function_Stop && !transitioning) {
			...
			else
			{
				...
				switch(SONG.song.toLowerCase())
				{
					case 'reminiscence':
					{
						PlayVideoState.videoID = 'yellow_end';
	...
	override function beatHit()
	{
		...
		if(curBeat % 64 == 0 && SONG.song.toLowerCase() == 'post-irony')
		{
			...
			var memestMemes:FlxSprite = new FlxSprite(FlxG.random.float(FlxG.width * -0.5, FlxG.width + 500), FlxG.random.float(FlxG.height * -0.5, FlxG.height + 500)).loadGraphic(Paths.imageRandom('danks/', 0, 16));
